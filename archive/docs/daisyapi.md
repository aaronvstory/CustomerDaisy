...
We recommend that you include max\_price with every request. This could help you prevent unexpected
...
If you need to wait, you'll be given the maximum UNIX timestamp at which the number will be ready.
